...
class Program
{
    ...
    static void Main(string[] args)
    {
        ...
        var argD = Path.Join(argS, "SolutionWalkerDb", "SolutionWalker.db");
        ...
        parser.ShowUsageHeader = "SolutionWalker CLI - A tool to import Visual Studio solutions into a SQLite database.";
